                    ...
                    var e,
                        ...
                        a =
                            (e /= i / 2) < 1
                                ? (a / 2) * e * e + t
                                : (-a / 2) * (--e * (e - 2) - 1) + t;
                    (n.scrollTop = a), l < i && setTimeout(s, 20);
                }
                null != t &&
...
class ThemeCustomizer {
    ...
    setSwitchFromConfig() {
        ...
        i &&
            ((e = document.querySelector(
                "input[type=radio][name=data-layout][value=" + i.nav + "]"
            )),
            (t = document.querySelector(
                "input[type=radio][name=data-bs-theme][value=" + i.theme + "]"
            )),
