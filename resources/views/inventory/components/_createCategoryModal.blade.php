    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createUserModalLabel">Create Category</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="createCategoryForm" class="btn btn-primary" id="createUserButton">Create Category</button>
            </div>
        </div>
    </div>
</div>