    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="createContractModalLabel">{{__('Create New Contract')}}</h5>
                    ...
                    <div class="col-md-6">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="operated_by" class="form-label">{{__('Operator')}} *</label>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="visits" class="form-label">{{__('Visits')}} *</label>
                                ...
                                <div class="mb-0" id="custom_terms_group" style="display:none;">
                                    <label for="custom_payment_terms" class="form-label">{{__('Custom Terms')}}</label>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-0">
                                    <label for="note" class="form-label">{{__('Internal Notes')}}</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="createContractForm" class="btn btn-primary" id="createContractButton">
                    <i class="fas fa-save me-2"></i>{{__('Create Contract')}}
                </button>
            </div>
        </div>
    </div>
