    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editBranchModalLabel">{{__('Update Branch')}}</h5>
            ...
            <div class="modal-body">
                <form id="editBranchForm" class="row" method="POST">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="edit_zone_id" class="form-label">{{__('Zone')}}*</label>
                        <select class="form-control" id="edit_zone_id" name="zone_id" required>
                            <option value="" disabled>{{__('Select Zone')}}</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3 col-md-12">
                        <label for="edit_map_link" class="form-label">{{__('Map Link')}}*</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="editBranchForm" class="btn btn-primary" id="editBranchButton">{{__('Update Branch')}}</button>
            </div>
        </div>
    </div>
</div>