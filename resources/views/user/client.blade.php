...
@section('title',__('Clients_panel'))
@section('content')
<div class="page-title-head d-flex align-items-center gap-2">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-bold mb-0">{{__('Clients')}}</h4>
    </div>
    ...
    <div class="text-end">
        ...
        <button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#createClientModal">{{__('Create Client')}}</button>
    </div>
</div>
