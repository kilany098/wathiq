            ...
            ->addColumn('action', function ($work_order) {
                $actionHtml = '
                    <div class="d-flex gap-2">
                        <form class="accept-form" action=' . route('pending.accept', $work_order->id) . ' method="POST" style="display: inline;">
                            ' . csrf_field() . '
                        ...
                        <form class="accept-form" action=' . route('pending.decline', $work_order->id) . ' method="POST" style="display: inline;">
                            ' . csrf_field() . '
                            <input type="hidden" name="_method" value="POST">
